...
class DeliveryXMLGenerator extends FileGenerator {
    ...
    public function generatePickListFile($debug = false) {
        ...
        $timestamp = date('YmdHis');  // RINO 22/07/2016 TODO verificare che il timestamp debba essere con le ore 0-24  date('YmdHis')
        //$file_name = $timestamp."-deliveries_cc_it_SG_WH_".$timestamp.".xml";
        $file_name = "deliveries_ov_it_SG_WH_".$timestamp.".xml"; // ordini italiani e spagnoli Rino 27/06
    ...
    private function generatePickList(DeliveryObject $delivery_object){
        ...
        if ($shipping_custom_attributes['clickAndCollectStoreId']) {
            ...
            //TODO mettere First Name e Last name con  quelli dell'utente
