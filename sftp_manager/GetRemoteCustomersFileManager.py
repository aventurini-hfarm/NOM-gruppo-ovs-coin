...
def getModifiedFiles():
    ...
    try:
        ...
        #stdin,stdout,stderr = ssh.exec_command("find /bus/mailboxes/demandwareprod/archive/in -cmin -5 |grep customer|grep "+data_esecuzione)
        stdin,stdout,stderr = ssh.exec_command("ls /bus/mailboxes/nom/out/customer*.xml")
        lista_files = []
...
def getFilesFromRemoteServer(lista_files):
    ...
    try:
        ...
        for file in lista_files:
            ...
            path_ordini = '/home/OrderManagement/testFiles/customer_export/inbound/'
