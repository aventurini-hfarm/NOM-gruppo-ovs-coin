...
def getModifiedFiles():
    ...
    try:
        ...
        #stdin,stdout,stderr = ssh.exec_command("find /bus/mailboxes/magazzino/archive/in -cmin -5 |grep roh|grep "+data_esecuzione)
        stdin,stdout,stderr = ssh.exec_command("ls /bus/mailboxes/nom/out/roh*")
        lista_files = []
