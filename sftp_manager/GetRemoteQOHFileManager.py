...
def getModifiedFiles():
    ...
    try:
        ...
        #stdin,stdout,stderr = ssh.exec_command("find /bus/mailboxes/magazzino/archive/in -cmin -120 |grep qoh|grep "+ data_esecuzione)
        stdin,stdout,stderr = ssh.exec_command("ls /bus/mailboxes/nom/out/qoh*")
        lista_files = []
...
def getFilesFromRemoteServer(lista_files):
    ...
    try:
        ...
        for file in lista_files:
            ...
            path_ordini = '/home/OrderManagement/testFiles/inventory_export/inbound/'
...
def removeRemoteFiles(lista_files):
    ...
    try:
        ...
        #stdin,stdout,stderr = ssh.exec_command("find /bus/mailboxes/demandwareprod/archive/in -cmin -5 |grep order|grep "+data_esecuzione)
