...
def getModifiedFiles():
    ...
    try:
        ...
        #stdin,stdout,stderr = ssh.exec_command("find /bus/mailboxes/magazzino/archive/in -cmin -5 |grep shipments|grep "+data_esecuzione)
        stdin,stdout,stderr = ssh.exec_command("ls /bus/mailboxes/nom/out/shipments*")
        lista_files = []
...
def getFilesFromRemoteServer(lista_files):
    ...
    try:
        ...
        for file in lista_files:
            ...
            path_ordini = '/home/OrderManagement/testFiles/shipments_export/inbound/'
