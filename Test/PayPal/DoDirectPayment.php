...
$DPFields = array(
					...
					'ipaddress' => '93.33.188.84', 							// Required.  IP address of the payer's browser.
...
$PayerInfo = array(
					'email' => 'vincenzo.sambucaro@nuvo.it', 								// Email address of payer.
...
$PayerName = array(
					...
					'firstname' => 'Vincenzo', 							// Payer's first name.  25 char max.
					'middlename' => '', 						// Payer's middle name.  25 char max.
					'lastname' => 'Sambucaro', 							// Payer's last name.  25 char max.
					'suffix' => ''								// Payer's suffix.  12 char max.
				);
				
$BillingAddress = array(
						'street' => 'Via Solferino', 						// Required.  First street address.
						'street2' => '', 						// Second street address.
						'city' => 'Milano', 							// Required.  Name of City.
						'state' => 'MILANO', 							// Required. Name of State or Province.
						'countrycode' => 'IT', 					// Required.  Country code.
						'zip' => '20110', 							// Required.  Postal code of payer.
...
$PaymentDetails = array(
						...
						'currencycode' => 'EUR', 					// Required.  Three-letter currency code.  Default is USD.
