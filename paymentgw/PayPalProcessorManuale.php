...
class PayPalProcessor {
    ...
    //Rino 15/07/2016 - TODO  USARE PER SVILUPPO
    ...
    //Rino 15/07/2016 - TODO  USARE PER PRODUZIONE
...
// Prepare request arrays
        $RTFields = array(
            ...
            'payerid' => $transactionId, 								// Encrypted PayPal customer account ID number.  Note:  Either transaction ID or payer ID must be specified.  127 char max
...
// Pass data into class for processing with PayPal and load the response array into $PayPalResult
    ...
    public function doRefundAll($transactionId, $amount) {
        // Create PayPal object.
        $PayPalConfig = array(
            'Sandbox' => $this->sandbox,
            'APIUsername' => $this->api_username,
...
$res =$t->doRefundAll('0E3546891P082943X',33.70);
print_r($res);
