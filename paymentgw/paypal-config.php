...
$sandbox = false;
$domain = $sandbox ? 'http://sandbox.domain.com/' : 'http://www.coincasa.it/';
 ...
 */
$developer_account_email = 'ecommerce.paypal@coin.it';
 ...
 */
$api_username = $sandbox ? 'ecommerce.paypal_api1.coin.it' : 'ecommerce.paypal_api1.coin.it';
$api_password = $sandbox ? 'FW4NK8MMZFML2WQ8' : 'BKWYTHCCGZ7C7HQ4';
$api_signature = $sandbox ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31A6h9UToVsl1ITrtutSdAQqypSBCW' : 'AjgDo5K0-8DQ6xlvVKsApcEh1NfEAg70Ss3a8RnGNzMpvDya0RoFof0k';
...
$device_id = '';
$device_ip_address = '130.211.59.246';
