...
require_once realpath(dirname(__FILE__))."/MagentoOrderHelperUpdater.php";
...
class OrderXMLAnalyzerUpdate {
    ...
    public function  processOrderSection(SimpleXMLElement $xmlContent = null)
    {
        ...
        $this->addItemOptions($order);
            ...
            $helper = new MagentoOrderHelperUpdater();

            $helper->updateOrder($order, $this->file);
...
//echo "\nStarting: ";
//$t = new OrderXMLAnalyzer('/home/OrderManagement/testFiles/order_export/archive/order_ov_it_DW_SG_20160918190501.xml');
...
//$t = new OrderXMLAnalyzerUpdate('/home/OrderManagement/testFiles/order_export/archive/./order_ov_es_DW_SG_20161025144502.xml');
