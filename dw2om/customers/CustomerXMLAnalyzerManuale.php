...
class CustomerXMLAnalyzerManuale {
...
$t = new CustomerXMLAnalyzer('/home/OrderManagement/testFiles/customer_export/archive/00021883.xml');
$t->process();
$t = new CustomerXMLAnalyzer('/home/OrderManagement/testFiles/customer_export/archive/00138803.xml');
$t->process();
$t = new CustomerXMLAnalyzer('/home/OrderManagement/testFiles/customer_export/archive/00773492.xml');
$t->process();
$t = new CustomerXMLAnalyzer('/home/OrderManagement/testFiles/customer_export/archive/00793373.xml');
$t->process();
$t = new CustomerXMLAnalyzer('/home/OrderManagement/testFiles/customer_export/archive/00816344.xml');
$t->process();
