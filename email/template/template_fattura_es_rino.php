	...
	<body>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
						FACTURA: 49350/E<?php echo $info_ordine->num_fattura; ?><br/>
			...
			<tr>
				...
				<td class="with-border">
					<table width="100%" style="border-spacing: 1px; padding: 2px;">
						<tr style="font-size:9px;">
							<td>
								Esta venta se efectúa aplicando el régimen de IVA español, en conformidad con el artículo 68.<br>
								Referencia – ley 37/1992 del 28 de diciembre, régimen de ventas a distancia.<br>
								A efectos de la normativa italiana, se informa que la presente venta se efectúa como<br>
								“No imponible a IVA italiano de conformidad con el Art. 41, apartado 1, letra B, del D.L. 331/1993”<br>
								Si desea realizar una devolución, consulte el sitio web OVS.es para más información.<br>
								Los datos personales facilitados por usted serán tratados exclusivamente para obedecer a su petición.<br>
								El tratamiento se realizará mediante los procedimientos más adecuados para garantizar la seguridad y la confidencialidad como se prevé en el D.L. 196/2003.<br>
								El titular del tratamiento de datos es OVS S.p.A. via Terraglio, 17 - 30174 Mestre – Venezia.<br>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						...
						<tr>
							<td width="70%">IVA: 21% INCL SPAIN</td>
