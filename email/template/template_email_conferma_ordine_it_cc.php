...
<body style='margin: 0; padding: 30px; font-size: 16px; font-family: Arial;'>
    ...
    <p>Ti confermiamo che l'ordine numero <?php echo $info_ordine->ordine; ?> &egrave;  stato spedito presso il negozio <?php echo $info_ordine->negozio; ?></p>
    ...
    <p>
    Stampa la ricevuta in allegato e portala con te in negozio per ritirare l'ordine.<br/>
