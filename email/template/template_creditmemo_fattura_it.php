	...
	<body>
			...
			<table width="100%" id="top" style="margin-top: 4px;" >
				<tr>					
					<td  width="60%" valign="middle">
						<img src="/home/OrderManagement/email/template/logo_ovs.png" alt="OVS"  width="150" align="middle" style="padding: 0" />
					</td>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
                        Nota di credito: <?php echo $infoFiscale->codice_ente.'0/'.$infoFiscale->registro_iva.$info_creditmemo->num_fattura; ?><br/>
                        Data: <?php echo $info_creditmemo->data_documento_fattura; ?><br/>
                        <?php if ($info_ordine->cf) {?>
                            Codice Fiscale: <?php echo $info_ordine->cf; ?><br/>
                        <?php } if($info_ordine->piva) {?>
                        Partita Iva: <?php echo $info_ordine->piva; ?><br/>
                        <?php }?>
                    </td>
                </tr>
            </table>
			...
			<table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
				<tr>
					<td valign="top" width="25%">
						...
						Via <?php echo $info_cliente['street']; ?><br/>
					...
					<td valign="top" width="25%">
						...
						Scontrino: <?php echo $info_creditmemo->scontrino; ?><br/>
						Data documento: <?php echo $info_creditmemo->data_documento; ?><br/>
					...
					<td valign="top" width="25%">
                        ...
                        Via <?php echo $info_destinatario->street; ?><br/>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						<tr>
							...
							<td width="30%"  align="right"><?php echo number_format(-1 * $info_creditmemo->imponibile ,2); ?><br/></td>
						</tr>	
						<tr>
							<td width="70%">IVA: Aliquota ordinaria <?php echo substr($infoFiscale->iva,2);?>% INCLUSA</td>
							<td width="30%" align="right"><?php echo number_format(-1 * $info_creditmemo->iva , 2); ?><br/><br/></td>
						</tr>	
						<tr>
							<td width="70%"  valign="center">TOTALE EUR:</td>
							<td width="30%"  valign="center" align="right"><?php echo number_format(-1 * $info_creditmemo->amount ,2 ); ?><br/><br/><br/><br/></td>
						</tr>	
						<tr>
