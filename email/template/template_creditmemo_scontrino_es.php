		...
		<div id="testata">
			<table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
				<tr>
					...
					<td valign="top" width="25%">
						INFORMACI&Oacute;N DE LA COMPRAE<br/><br/>
						Cliente: <?php echo $info_ordine->cliente; ?><br/>
						Recibo: <?php echo $info_creditmemo->scontrino; ?><br/>
						Fecha: <?php echo $info_creditmemo->data_documento; ?><br/>
			...
			<tr>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						...
						<tr>
							<td width="70%">IVA: <?php echo substr($infoFiscale->iva,2);?>% INCL</td>
