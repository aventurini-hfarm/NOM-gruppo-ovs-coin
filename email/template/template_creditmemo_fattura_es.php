	...
	<body>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
                        Nota de cr&eacute;dito: <?php echo $infoFiscale->codice_ente.'0/'.$infoFiscale->registro_iva.$info_creditmemo->num_fattura; ?><br/>
						Fecha: <?php echo $info_creditmemo->data_documento_fattura; ?><br/>
