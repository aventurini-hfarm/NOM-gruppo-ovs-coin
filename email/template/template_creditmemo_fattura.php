	...
	<body>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
                        Nota di Credito: 45630/<?php echo $info_creditmemo->num_fattura; ?><br/>
					...
					<table width="100%" style="border-spacing: 1px;">
						<tr width="100%">
							<td valign="center" align="center" width="100%">
                                <br/><br/><br/>
							    <img width="200" src="/home/OrderManagement/email/template/codice_barre_ovs.png"/>
							</td>
						</tr>
					<tr>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						<tr>
							...
							<td width="30%"  align="right"><?php echo -1 * $info_creditmemo->imponibile; ?><br/></td>
						</tr>	
						<tr>
							<td width="70%">IVA: Aliquota ordinaria 22% INCLUSA</td>
							<td width="30%" align="right"><?php echo -1 * $info_creditmemo->iva; ?><br/><br/></td>
						</tr>	
						<tr>
							<td width="70%"  valign="center">TOTALE EUR:</td>
							<td width="30%"  valign="center" align="right"><?php echo -1 * $info_creditmemo->amount; ?><br/><br/><br/><br/></td>
						</tr>	
						<tr>
