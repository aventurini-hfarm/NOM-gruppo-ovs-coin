...
<body style='margin: 0; padding: 30px; font-size: 16px; font-family: Arial;'>
    ...
    <p>Due to logistical reasons, the order number  <?php echo $info_ordine->ordine; ?> will be delivered in two different shipments.</p>

    <p>From tomorrow, you will be able to track the first shipment on the currier website at the following link:</p>

    <p><?php echo '<a href="'.$info_ordine->tracking_url.'">'.$info_ordine->tracking_url.'</a>'; ?></p>

    <p>We will send you another email with the tracking link for the second delivery when the remaining items in your order will be handed to the courier.</p>
