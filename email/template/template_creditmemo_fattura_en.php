	...
	<body>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
                        Credit note: <?php echo $infoFiscale->codice_ente.'0/'.$infoFiscale->registro_iva.$info_creditmemo->num_fattura; ?><br/>
						Date: <?php echo $info_creditmemo->data_documento_fattura; ?><br/>
                        <?php if ($info_ordine->cf) {?>
							Fiscale Code: <?php echo $info_ordine->cf; ?><br/>
			...
			<table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
				<tr>
					...
					<td valign="top" width="25%">
						...
						Receipt: <?php echo $info_creditmemo->scontrino; ?><br/>
						Document Date: <?php echo $info_creditmemo->data_documento; ?><br/>
			...
			<tr>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						...
						<tr>
							<td width="70%">VAT: <?php echo substr($infoFiscale->iva,2);?>% </td>
