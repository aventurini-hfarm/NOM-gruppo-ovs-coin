	...
	<body>
        ...
        <div id="testata_fattura">
            <table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
                <tr>
                    <td>
                        Fattura: <?php echo $infoFiscale->codice_ente.'0/'.$infoFiscale->registro_iva.$info_ordine->num_fattura; ?><br/>
                        Data: <?php echo $info_ordine->data_documento_fattura; ?><br/>
			...
			<table style="font-size:10px; margin-top: 4px; " width="100%" align="center">
				<tr>
					...
					<td valign="top" width="25%">
                        ...
                        <?php echo $infoOrdine->negozio; ?><br/>
                        <?php echo $infoOrdine->indirizzo_negozio; ?><br/>
                        <?php echo $infoOrdine->negozio_paese; ?><br/>
                        <?php echo $infoOrdine->country; ?><br/>
				...
				<td valign="top" width="35%" class="with-border">
					<table  width="100%">
						...
						<tr>
							...
							<td width="30%" align="right"><?php echo $info_ordine->iva; ?><br/><br/></td>
						</tr>	
						<tr>
